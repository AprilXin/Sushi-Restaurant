...
//		add(player_chef_ui, BorderLayout.EAST);
		...
		player_chef_ui = new PlayerViewWidget(game_model.getBelt());
		add(player_chef_ui, BorderLayout.EAST);
		
//		BeltView belt_view = new BeltView(game_model.getBelt());
//		add(belt_view, BorderLayout.CENTER);
		
		PlateViewWidget plate_view = new PlateViewWidget(game_model.getBelt());
		add(plate_view, BorderLayout.CENTER);
